...
class Jframe extends JFrame implements ActionListener{
   ...
   private JMenuItem misave,mireturn,mirenew,usehelp;
	...
	JTextField dvdprice=new JTextField();
	...
	usehelp.addActionListener(this);//------------菜单栏监听器
		...
		user.setEditable(true);
		 ...
		 rent1.setBounds(350,300,150,90);
		...
		usernamelabel.setBounds(250,100,150,30);
		usernamelabel.setFont(new Font("",Font.BOLD,20));
		userid.setBounds(100,150,100,30);
		useridlabel.setBounds(250,150,150,30);
		useridlabel.setFont(new Font("",Font.BOLD,20));
		dvdname1.setBounds(100,200,100,30);
		dvdnamelabel.setBounds(250,200,150,30);
		dvdnamelabel.setFont(new Font("",Font.BOLD,20));
		dvdid.setBounds(100,250,100,30);
		dvdidlabel.setBounds(250,250,150,30);
		dvdidlabel.setFont(new Font("",Font.BOLD,20));
		rentdate.setBounds(100,300,100,30);
		rentdatelabel.setBounds(250,300,150,30);
		rentdatelabel.setFont(new Font("",Font.BOLD,20));
		rentdate2.setBounds(100,350,100,30);
		rentdatelabel2.setBounds(250,350,150,30);
	    rentdatelabel2.setFont(new Font("",Font.BOLD,20));
		rent.setBounds(250,450,100,30);
