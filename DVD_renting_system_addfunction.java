...
public class DVD_renting_system_addfunction {
		...
		//	String a[]=null;a[0]=dvdname.getText().trim();a[1]=dvdpublisher.getText().trim();a[2]=dvdnumber.getText().trim();a[3]=dvdprice.getText().trim();
		         ...
		         while((lineStr=br.readLine())!=null){
		        	String[] info=lineStr.split("\\|");
		        	 ...
		        	 for(int i=0;i<info.length;i++){
		        		 ...
		        		 JOptionPane.showMessageDialog(null,"查询成功：DVD片名："+info[a-2]+"    DVD出版社："+info[a-1]+"    DVD编号："+info[a]+"    DVD价格："+info[a+1]+"    DVD可租出数："+info[a+2],"搜索结果",JOptionPane.INFORMATION_MESSAGE);
		        		 }
		        	  else{
	        ...
	        while((lineStr2=br2.readLine())!=null){
	        	...
	        	for(int i=0;i<info2.length;i++){
	        	 ...
	        	 JOptionPane.showMessageDialog(null,"租借成功：DVD片名："+info[a-2]+"    DVD出版社："+info[a-1]+"    DVD编号："+info[a]+"    需支付金额："+info[a+1],"搜索结果",JOptionPane.INFORMATION_MESSAGE);
	        		 fos=new FileOutputStream("c:\\Temp\\rent.txt",true);
		         ...
		         while((lineStr=br.readLine())!=null){
		        	String[] info=lineStr.split("\\|");
		        	 ...
		        	 for(int i=0;i<info.length;i++){
		        		 ...
		        		 JOptionPane.showMessageDialog(null,"查询成功：姓名："+info[a-1]+"    身份证号："+info[a]+"    在租DVD："+info[a+1]+"    在租DVD编号："+info[a+2]+"    租借月份："+info[a+3]+"    租借日："+info[a+4]+"    支付金额："+info[a+5],"搜索结果",JOptionPane.INFORMATION_MESSAGE);
		        		 }
		        	  else{
