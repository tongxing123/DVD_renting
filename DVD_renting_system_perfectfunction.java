...
public class DVD_renting_system_perfectfunction {
...
class Jframe extends JFrame implements ActionListener{
	...
	JButton allsearchbutton=new JButton("DVD全部搜索");
	...
	usehelp.addActionListener(this);//------------菜单栏监听器
		...
		allsearchbutton.setFont(new Font("",Font.BOLD,20));
		         ...
		         while((lineStr=br.readLine())!=null){
		        	String[] info=lineStr.split("\\|");
		        	 ...
		        	 for(int i=0;i<info.length;i++){
		        		 ...
		        		 JOptionPane.showMessageDialog(null,"查询成功：DVD片名："+info[a-2]+"    DVD出版社："+info[a-1]+"    DVD编号："+info[a]+"  \n  DVD价格："+info[a+1]+"    DVD可租出数："+info[a+2],"搜索结果",JOptionPane.INFORMATION_MESSAGE);
		        		 }
		        	  else{
